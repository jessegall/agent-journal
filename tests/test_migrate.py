...
ran = migrate(other)
check("a fresh record runs every migration once and writes the ledger", (ran, sorted(applied(other))), (["m0001_the_old_record", "m0002_rule_targets", "m0003_unify_rule_injection"], ["m0001_the_old_record", "m0002_rule_targets", "m0003_unify_rule_injection"]))
