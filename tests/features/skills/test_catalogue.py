...
check("the catalogue reads every SKILL.md under the library and the agent homes, with its frontmatter", (auto[SKILL.description], auto[SKILL.path]), ("Auto mode", ".agents/skills/journal-auto/SKILL.md"))
...
check("the start block names current skills in the library, not obsolete provider-only ones", ("Skill: journal-auto" in start_block(record), "journal-obsolete" in start_block(record)), (True, False))
