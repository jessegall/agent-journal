...
from providers.base import start_file  # noqa: E402
...
start = lambda source: provider.handle(record.root, record.env, {"hook_event_name": "SessionStart", "session_id": "s-1", "source": source})["hookSpecificOutput"]["additionalContext"]
