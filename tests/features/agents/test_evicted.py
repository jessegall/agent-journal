...
check("granted: a pin is still refused", allowed(sessions, "claude-1", "t", "agent-7", "fact"), "a subagent never writes a pin: report it, and the main conversation files it")
check("no subagent named: nothing to check", allowed(sessions, "claude-1", "t", "", "fact"), "")
