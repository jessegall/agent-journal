...
from migrations import names  # noqa: E402
said = upgrade(project)
check("upgrade wires, writes skills and runs the migrations, and says so", (any("skills" in l for l in said), said[-2:]), (True, [f"migrations run: {', '.join(names())}", "package moved into src/: 1 files out of the record"]))
