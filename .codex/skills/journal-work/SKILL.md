...
It listens to: agent.updated, work.completed, work.created. It speaks on worked. On by default; the viewer's Settings switches it per environment, and `triggers.work` in the environment's settings tunes it.
