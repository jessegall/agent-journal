# Code Commandments — 54 sins to fix
...
- `./src/engine/keeper.py:165`  conditional  [InventedDefaultDetector]
...
- `./src/engine/services.py:128`  call  [DictBagDetector]
...
- `./src/features/dumps/controller.py:100`  call  [DictBagDetector]
- `./src/features/message_buttons/shaping.py:21`  call  [DictBagDetector]
- `./src/features/message_buttons/shaping.py:22`  call  [DictBagDetector]
- `./src/features/message_buttons/shaping.py:23`  call  [DictBagDetector]
- `./src/features/permission_prompts/handlers.py:16`  call  [DictBagDetector]
- `./src/features/permission_prompts/handlers.py:16`  call  [DictBagDetector]
- `./src/features/plugins/commands.py:86`  call  [DictBagDetector]
- `./src/features/plugins/commands.py:97`  call  [DictBagDetector]
- `./src/features/plugins/declared.py:97`  call  [DictBagDetector]
- `./src/features/plugins/declared.py:97`  call  [DictBagDetector]
- `./src/features/plugins/declared.py:97`  call  [DictBagDetector]
- `./src/features/plugins/declared.py:97`  call  [DictBagDetector]
...
- `./src/features/plugins/parts.py:77`  call  [DictBagDetector]
- `./src/features/plugins/parts.py:95`  call  [DictBagDetector]
- `./src/features/plugins/payload.py:36`  call  [DictBagDetector]
- `./src/features/skill_loading/test.py:116`  call  [DictBagDetector]
- `./src/features/status_bar/usage.py:14`  call  [DictBagDetector]
...
- `./src/providers/codex.py:259`  call  [DictBagDetector]
- `./src/providers/codex.py:259`  call  [DictBagDetector]
- `./src/providers/codex.py:259`  call  [DictBagDetector]
