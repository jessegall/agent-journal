# Code Commandments — 33 sins to fix
...
- `./src/commands/dispatch.py:210`  call  [DictBagDetector]
- `./src/commands/dispatch.py:210`  call  [DictBagDetector]
- `./src/engine/events.py:76`  call  [DictBagDetector]
- `./src/engine/seat.py:78`  call  [DictBagDetector]
- `./src/features/auto_update/launch.py:27`  call  [DictBagDetector]
- `./src/features/auto_update/launch.py:27`  call  [DictBagDetector]
- `./src/features/command_tags/reading.py:33`  call  [DictBagDetector]
- `./src/features/command_tags/reading.py:62`  call  [DictBagDetector]
...
- `./src/features/skill_loading/test.py:116`  call  [DictBagDetector]
- `./src/features/templates/resource.py:49`  call  [DictBagDetector]
...
- `./src/providers/base.py:70`  call  [DictBagDetector]
- `./src/providers/codex.py:274`  call  [DictBagDetector]
- `./src/providers/codex.py:274`  call  [DictBagDetector]
- `./src/providers/codex.py:274`  call  [DictBagDetector]
