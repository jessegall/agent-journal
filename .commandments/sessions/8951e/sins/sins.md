# Code Commandments — 2 sins to fix
...
- `./src/web/src/board/CardMenu.vue:51`  <template>  [NearDuplicateElementDetector] — same shape as src/web/src/board/CardMenu.vue:60
- `./src/web/src/board/CardMenu.vue:60`  <template>  [NearDuplicateElementDetector] — same shape as src/web/src/board/CardMenu.vue:51
