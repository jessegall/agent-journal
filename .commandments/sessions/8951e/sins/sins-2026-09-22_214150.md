# Code Commandments — 10 sins to fix
...
- `./web/src/chat/DumpWindow.vue:576`  <div>  [DeepDataReachDetector]
- `./web/src/chat/DumpWindow.vue:576`  <div>  [DeepNestedDetector]
- `./web/src/chat/DumpWindow.vue:601`  <template>  [DeepNestedDetector]
- `./web/src/chat/DumpWindow.vue:630`  <template>  [DeepNestedDetector]
