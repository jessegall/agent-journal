...
GROUPS: dict[str, tuple[str, ...]] = {
    ...
    "environments": (
        ...
        'journal environments handoff "<name>" "<source>"   an environment made ready BY AGENTS: creates and delegates it, prints the hand-off agent\'s prompt',
        'journal environments handoff "<name>" --run        when it reports READY: the runner\'s prompt; --off when the run is over',
