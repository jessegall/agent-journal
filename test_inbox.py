...
check("filing a message writes nothing under it: what it became is the pills, not a second bubble",
      _replies(1), [])
...
check("and the agent's own answer is the only thing under a message",
