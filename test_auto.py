...
check("todo auto alone reports the state", "auto mode is ON" in out, True)
code, out = s.journal("auto-mode")
check("auto-mode alone reports the state too", "auto mode is ON" in out, True)
code, out = s.journal("auto-mode", "disable")
...
check("and the two ways out", ("loop set" in denied, "auto-mode disable" in denied), (True, True))
