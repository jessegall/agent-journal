...
WORKING_A_BOARD_CARD = {
    ...
    "steps": [
        ("Say what they mean", "Your first turn never drafts. From the first question on, narrow down what they already want: "
                               ...
                               "never filler like Yes / Yes, but / No. Each option is one of your likely readings of what "
                               "they want, so picking one tells you; the input stays for their own words on every turn but the "
                               "final choices, where they can only click. Yes or no suits a sharp guess. Make a real guess from their words, the board's name and the "
