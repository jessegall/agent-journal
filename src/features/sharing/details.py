...
class SharingDetails(FeatureDetails):
    name = "sharing"
    when = "the user wants to show a document or a collection to someone outside the journal"

    title = "Sharing"

    abstract = """
        Share a document or a collection with someone outside the journal through a tunler link that
    ...
    help = """
        ...
        never sets when it ends. journal share opens doc:12 says what the link would open before you
        make it, and journal share stop <n> ends one at once. Share only when the user asks, and put
