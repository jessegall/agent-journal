...
def manifest(root: Path | None = None) -> dict:
    return {
        ...
        "types": {name: {"title": c.details.title, "abstract": c.details.abstract, "help": c.details.help, "view": c.view, "in_sidebar": c.in_sidebar, "listed_under": c.listed_under, "listed_as_cards": c.listed_as_cards, "created_in_viewer": c.created_in_viewer, "scope": c.scope, "icon": c.icon, "needs_attention": c.needs_attention, "lists_completed_unread": c.lists_completed_unread, "cleared_by": c.cleared_by, "filters": tabs(c), "nested": c.nested, "takes_comments": c.takes_comments, "closed_first": c.closed_first, "notified": list(c.notified), "typed_as_title": c.typed_as_title, "start_as_count": c.start_as_count, "fields": c.fields, "shown_fields": list(c.shown_fields), "choices": c.choices, "labels": c.labels,
