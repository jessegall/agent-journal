...
ACTIONS = ("created", "updated", "deleted", "linked", "commented", "completed", "reopened", "stamped", "reported", "raised", "dispatched", "returned", "fired", REQUESTED, REVISED, COMMISSIONED, STARTED, PLAN_WAITS, CHECKPOINT, FINISHED, STUCK)
RAISED = "raised"
