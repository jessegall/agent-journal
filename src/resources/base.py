...
STARTED = "started"
PLAN_WAITS, CHECKPOINT, FINISHED, STUCK = "plan_waits", "checkpoint", "finished", "stuck"
ESCALATED, PAUSED, RESUMED = "escalated", "paused", "resumed"
ACTIONS = ("created", "updated", "deleted", "linked", "commented", "completed", "reopened", "stamped", "reported", "raised", "dispatched", "returned", "fired", REQUESTED, REVISED, COMMISSIONED, STARTED, PLAN_WAITS, CHECKPOINT, FINISHED, STUCK, ESCALATED, PAUSED, RESUMED)
RAISED = "raised"
