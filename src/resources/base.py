...
STARTED = "started"
ACTIONS = ("created", "updated", "deleted", "linked", "commented", "completed", "reopened", "stamped", "reported", "raised", "dispatched", "returned", "fired", REQUESTED, REVISED, COMMISSIONED, STARTED)
RAISED = "raised"
