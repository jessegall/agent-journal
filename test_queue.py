...
check("the default order, an override, a bad override ignored, and the numbers",
      (got[0], got[1][:2], got[2]), (["claimed", "environment", "inbox", "comments", "loop", "context", "deferral", "untagged", "questions", "suggestions", "suggest_hint", "work", "auto", "recall", "cleanup"], ["work", "claimed"], [["claimed", 4], ["environment", 5]]))
s11 = S()
