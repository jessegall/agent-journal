...
from commands import auto, comments, connections, docs, notices, notifications, plans, reports, suggestions, environments, inbox, pins, questions, reminders, status, style, system, todos, tools, transcript, work
from commands.options import SHARED

REGISTRY = Registry(shared=SHARED)
for module in (auto, comments, connections, reports, plans, notices, notifications, suggestions, questions, inbox, reminders, pins, work, todos, docs, tools, style, environments, transcript, system, status):
