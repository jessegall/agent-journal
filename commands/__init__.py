...
from commands import auto, comments, docs, notifications, reports, suggestions, environments, inbox, pins, questions, reminders, status, system, todos, tools, transcript, work
from commands.options import SHARED

REGISTRY = Registry(shared=SHARED)
for module in (auto, comments, reports, notifications, suggestions, questions, inbox, reminders, pins, work, todos, docs, tools, environments, transcript, system, status):
