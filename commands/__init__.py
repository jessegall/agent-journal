...
from commands import auto, browser, comments, connections, docs, notices, notifications, reactions, plans, reports, suggestions, environments, inbox, pins, questions, reminders, status, style, system, todos, tools, transcript, work
from commands.options import SHARED

REGISTRY = Registry(shared=SHARED)
for module in (auto, browser, comments, connections, reports, plans, notices, notifications, reactions, suggestions, questions, inbox, reminders, pins, work, todos, docs, tools, style, environments, transcript, system, status):
