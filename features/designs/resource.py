...
from resources.base import DOCUMENT, LAZY, PROJECT, Resource, ResourceDetails
...
class Design(Shape, Resource):
    ...
    data_fields: ClassVar[list[Field]] = [
        Field(default=list, name="revisions"),
    ...
    details: ClassVar[ResourceDetails] = ResourceDetails(
        title="Design",
        abstract="A document rewritten in place: every edit is a new revision, and every revision stays readable",
        help=("A design always reads as it stands now. Its latest revision stays open while it is worked on: edits change it in place. "
