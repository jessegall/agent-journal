...
MESSAGES = {
    ...
    "receipt": "Filed {became:, } from your message.",
    ...
    "cmd_reply": 'journal messages reply {n} "<the answer>" --part="<the question\'s words>" [--follow-up="<question>" --option=…]',
    "cmd_reply_what": "a part that asks something: answer it, and ask what the answer leaves open",
