...
def fresh():
    ...
    testkit.make(d, SRC)
    # THE SESSION HAS TO HAVE CHOSEN: there is no default environment, and an unbound session's
    # journal commands are refused (test_unbound covers that). This suite is about spellings.
...
check("there is a focused skill per part, beside the core one", _focused,
      ["journal-agents", "journal-docs", "journal-memory", "journal-messages", "journal-plans", "journal-questions",
       "journal-reports", "journal-todos", "journal-transcripts"])
