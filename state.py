...
IN_RECORD = {"activity_show", "activity_keep", "pins", "work", "rules", "tracks", "current", "previous", "sessions", "auto",
             ...
             "cleanup_kept", "ideas",
             "agent_seen", "agent_parent", "agents_done", "always_load_skills", "schema", "hooks_enabled", "viewer_port", "reports_archive_days", "session_pids"}
...
TRACKED = ("pins", "work", "reminders", "questions", "inbox", "comments", "reports", "notifications", "suggestions", "activity")
_TRACK: list = []
